...
describe('Users', () => {
    ...
    before(async () => {
        ...
        orgId = (await AuthenticationUtil.findGuestOrganization()).id;
    });
    ...
    it('should create a user', async () => {
        ...
        expect(response.body.model.username).to.equal(user.email);
        expect(response.body.model.passwordHash).should.not.equal(user.password);
    });
